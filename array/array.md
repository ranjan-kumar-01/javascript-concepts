1️⃣ Array Definition - An array in JavaScript is a special variable that can store multiple values in a single variable, and the values can be of any type.
